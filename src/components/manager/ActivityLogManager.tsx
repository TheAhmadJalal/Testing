...
const ActivityLogManager: React.FC = () => {
  ...
  const handlePrint = () => {
    ...
    printWindow.document.write(`
      ...
      <html>
        ...
        <body>
          <h1>${settings?.schoolName || "School"} - Activity Logs</h1>
  ...
  const handleExport = () => {
    ...
    csvContent += "Time,User,Role,Action,Details\n";
    ...
    link.setAttribute(
      "download",
      `${settings?.electionTitle || "election"}_activity_logs_${
