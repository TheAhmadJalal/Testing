...
const Footer: React.FC = () => {
  ...
  // Don't show footer on thank you page and login page
  if (location.pathname === "/thank-you" || location.pathname === "/login") {
    return null;
  }
    ...
    <footer className="bg-gray-800 text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-semibold">Peki Senior High School</h3>
            </div>
            <p className="text-gray-400 mb-4">
              Empowering students through democratic participation and
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li className="flex items-center">
                ...
                <span>info@pekishs.edu.gh</span>
              </li>
              <li className="flex items-center">
                <Phone className="h-5 w-5 mr-2" />
                <span>+233 302 123 456</span>
              </li>
              <li>P.O. Box 123, Peki, Volta Region, Ghana</li>
            </ul>
          </div>
          <div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-center text-gray-400">
          <p>
            © {new Date().getFullYear()} Peki Senior High School. All rights
            reserved.
          </p>
          <p className="text-sm mt-2">
            Developed by Packets Out LLC (Smart Systems)
          </p>
        </div>
      </div>
      <p className="text-sm mt-2">
